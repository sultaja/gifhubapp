export const en = {
  ...
  submit_page: {
    ...
    form: {
      ...
      tags: "Tags",
      tags_placeholder: "e.g. celebration, success, the office",
      tags_desc: "Separate tags with a comma.",
      loading: "Loading...",
    },
  ...
  admin: {
    ...
    settings: {
      ...
      verification_title: "Site Verification (Manual Step)",
      verification_desc: "To verify your site with services like Google Search Console, you **must** manually add the provided HTML tag to your `index.html` file. This is required because verification bots do not run JavaScript and cannot see scripts added from the admin panel.",
      verification_file: "File to edit: `index.html`",
      seo_title: "Page Titles (SEO)",
      seo_desc: "Set custom titles for your main pages.",
      scripts_title: "Analytics & Tracking Scripts",
      scripts_desc: "Use this section for scripts that can be loaded by the browser, such as Google Analytics, marketing pixels, or live chat widgets. **Do not use this for verification tags.**",
