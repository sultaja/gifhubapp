export const en = {
  ...
  admin: {
    ...
    settings: {
      ...
      verification_title: "Site Verification",
      verification_desc: "For services like Google Search Console, paste your HTML verification tag directly into the main `index.html` file. This ensures verification bots can find it.",
      ...
      header_scripts_desc: "Add scripts like Google Analytics here. They will be loaded by the browser. **Do not use this for site verification tags.** Scripts will be added before the closing `</head>` tag.",
